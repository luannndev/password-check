...
def check_password_strength(password):
    ...
    if len(password) >= 8 and re.search("[a-z]", password) and re.search("[A-Z]", password) and re.search("[0-9]",
                                                                                                          password) and re.search(
            "[@#$%^&+=]", password):
        strength = "Strong"
    elif len(password) >= 6 and (re.search("[a-z]", password) or re.search("[A-Z]", password)) and re.search("[0-9]",
                                                                                                             password):
        strength = "Moderate"
